...
class NtescoRevealLayout : ViewGroup {
    /**
    ...
    var mDragStateChangeListener // only used for ViewBindHelper
    ...
    interface SwipeListener {
         ...
         */
        fun onClosed(view: NtescoRevealLayout?)

        /**
         * Called when the main view becomes completely opened.
         */
        fun onOpened(view: NtescoRevealLayout?)

        /**
         * Called when the main view's position changes.
         * @param slideOffset The new offset of the main view within its range, from 0-1
         */
        fun onSlide(view: NtescoRevealLayout?, slideOffset: Float)
    }

    /**
     * No-op stub for [NtescoRevealLayout.SwipeListener]. If you only want ot implement a subset
     * of the listener methods, you can extend this instead of implement the full interface.
     */
    class SimpleSwipeListener : SwipeListener {
        override fun onClosed(view: NtescoRevealLayout?) {}
        override fun onOpened(view: NtescoRevealLayout?) {}
        override fun onSlide(view: NtescoRevealLayout?, slideOffset: Float) {}
    }
     ...
     * @param animation true to animate the open motion. [NtescoRevealLayout.SwipeListener] won't be
     ...
     * @param animation true to animate the close motion. [NtescoRevealLayout.SwipeListener] won't be
     * called if is animation is false.
     */
    ...
    private fun initRects() {
        ...
        mRectSecOpen[secOpenLeft, secOpenTop, secOpenLeft + mSecondaryView!!.width] = secOpenTop + mSecondaryView!!.height
    }
        ...
        override fun onViewPositionChanged(changedView: View, left: Int, top: Int, dx: Int, dy: Int) {
            ...
            if (mSwipeListener != null && isMoved) {
                if (mMainView!!.left == mRectMainClose.left && mMainView!!.top == mRectMainClose.top) {
                    mSwipeListener!!.onClosed(this@NtescoRevealLayout)
                } else if (mMainView!!.left == mRectMainOpen.left && mMainView!!.top == mRectMainOpen.top) {
                    mSwipeListener!!.onOpened(this@NtescoRevealLayout)
                } else {
                    mSwipeListener!!.onSlide(this@NtescoRevealLayout, slideOffset)
                }
            }
            mLastMainLeft = mMainView!!.left
            mLastMainTop = mMainView!!.top
            ViewCompat.postInvalidateOnAnimation(this@NtescoRevealLayout)
        }
    ...
    companion object {
        ...
        const val DEFAULT_MIN_DIST_REQUEST_DISALLOW_PARENT = 1 // dp
